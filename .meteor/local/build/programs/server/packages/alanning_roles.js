...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////     // 3
//                                                                                                         //     // 4
// packages/alanning:roles/roles_server.js                                                                 //     // 5
//                                                                                                         //     // 6
/////////////////////////////////////////////////////////////////////////////////////////////////////////////     // 7
                                                                                                           //     // 8
;(function () {                                                                                            // 1   // 9
                                                                                                           ...
                                                                                                           // 3   // 11
/**                                                                                                        // 4   // 12
 * Roles collection documents consist only of an id and a role name.                                       // 5   // 13
 *   ex: { _id:<uuid>, name: "admin" }                                                                     // 6   // 14
 */                                                                                                        // 7   // 15
if (!Meteor.roles) {                                                                                       // 8   // 16
  Meteor.roles = new Meteor.Collection("roles")                                                            // 9   // 17
                                                                                                           // 10  // 18
  // Create default indexes for roles collection                                                           // 11  // 19
  Meteor.roles._ensureIndex('name', {unique: 1})                                                           // 12  // 20
}                                                                                                          // 13  // 21
                                                                                                           // 14  // 22
                                                                                                           // 15  // 23
/**                                                                                                        // 16  // 24
 * Always publish logged-in user's roles so client-side                                                    // 17  // 25
 * checks can work.                                                                                        // 18  // 26
 */                                                                                                        // 19  // 27
Meteor.publish(null, function () {                                                                         // 20  // 28
  var userId = this.userId,                                                                                // 21  // 29
      fields = {roles:1}                                                                                   // 22  // 30
                                                                                                           // 23  // 31
  return Meteor.users.find({_id:userId}, {fields: fields})                                                 // 24  // 32
})                                                                                                         // 25  // 33
                                                                                                           // 26  // 34
}());                                                                                                      // 27  // 35
                                                                                                           // 28  // 36
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////     // 48
//                                                                                                         //     // 49
// packages/alanning:roles/roles_common.js                                                                 //     // 50
//                                                                                                         //     // 51
/////////////////////////////////////////////////////////////////////////////////////////////////////////////     // 52
                                                                                                           //     // 53
;(function () {                                                                                            // 1   // 54
                                                                                                           // 2   // 55
/**                                                                                                        // 3   // 56
 * Provides functions related to user authorization. Compatible with built-in Meteor accounts packages.    // 4   // 57
 *                                                                                                         // 5   // 58
 * @module Roles                                                                                           // 6   // 59
 */                                                                                                        // 7   // 60
                                                                                                           // 8   // 61
/**                                                                                                        // 9   // 62
 * Roles collection documents consist only of an id and a role name.                                       // 10  // 63
 *   ex: { _id:<uuid>, name: "admin" }                                                                     // 11  // 64
 */                                                                                                        // 12  // 65
if (!Meteor.roles) {                                                                                       // 13  // 66
  Meteor.roles = new Meteor.Collection("roles")                                                            // 14  // 67
}                                                                                                          // 15  // 68
                                                                                                           // 16  // 69
/**                                                                                                        // 17  // 70
 * Role-based authorization compatible with built-in Meteor accounts package.                              // 18  // 71
 *                                                                                                         // 19  // 72
 * Stores user's current roles in a 'roles' field on the user object.                                      // 20  // 73
 *                                                                                                         // 21  // 74
 * @class Roles                                                                                            // 22  // 75
 * @constructor                                                                                            // 23  // 76
 */                                                                                                        // 24  // 77
if ('undefined' === typeof Roles) {                                                                        // 25  // 78
  Roles = {}                                                                                               // 26  // 79
}                                                                                                          // 27  // 80
                                                                                                           // 28  // 81
"use strict";                                                                                              // 29  // 82
                                                                                                           // 30  // 83
var mixingGroupAndNonGroupErrorMsg = "Roles error: Can't mix grouped and non-grouped roles for same user"; // 31  // 84
                                                                                                           // 32  // 85
_.extend(Roles, {                                                                                          // 33  // 86
                                                                                                           // 34  // 87
  /**                                                                                                      // 35  // 88
   * Constant used to reference the special 'global' group that                                            // 36  // 89
   * can be used to apply blanket permissions across all groups.                                           // 37  // 90
   *                                                                                                       // 38  // 91
   * @example                                                                                              // 39  // 92
   *     Roles.addUsersToRoles(user, 'admin', Roles.GLOBAL_GROUP)                                          // 40  // 93
   *     Roles.userIsInRole(user, 'admin') // => true                                                      // 41  // 94
   *                                                                                                       // 42  // 95
   *     Roles.setUserRoles(user, 'support-staff', Roles.GLOBAL_GROUP)                                     // 43  // 96
   *     Roles.userIsInRole(user, 'support-staff') // => true                                              // 44  // 97
   *     Roles.userIsInRole(user, 'admin') // => false                                                     // 45  // 98
   *                                                                                                       // 46  // 99
   * @property GLOBAL_GROUP                                                                                // 47  // 100
   * @type String                                                                                          // 48  // 101
   * @static                                                                                               // 49  // 102
   * @final                                                                                                // 50  // 103
   */                                                                                                      // 51  // 104
  GLOBAL_GROUP: '__global_roles__',                                                                        // 52  // 105
                                                                                                           // 53  // 106
                                                                                                           // 54  // 107
  /**                                                                                                      // 55  // 108
   * Create a new role. Whitespace will be trimmed.                                                        // 56  // 109
   *                                                                                                       // 57  // 110
   * @method createRole                                                                                    // 58  // 111
   * @param {String} role Name of role                                                                     // 59  // 112
   * @return {String} id of new role                                                                       // 60  // 113
   */                                                                                                      // 61  // 114
  createRole: function (role) {                                                                            // 62  // 115
    var id,                                                                                                // 63  // 116
        match                                                                                              // 64  // 117
                                                                                                           // 65  // 118
    if (!role                                                                                              // 66  // 119
        || 'string' !== typeof role                                                                        // 67  // 120
        || role.trim().length === 0) {                                                                     // 68  // 121
      return                                                                                               // 69  // 122
    }                                                                                                      // 70  // 123
                                                                                                           // 71  // 124
    try {                                                                                                  // 72  // 125
      id = Meteor.roles.insert({'name': role.trim()})                                                      // 73  // 126
      return id                                                                                            // 74  // 127
    } catch (e) {                                                                                          // 75  // 128
      // (from Meteor accounts-base package, insertUserDoc func)                                           // 76  // 129
      // XXX string parsing sucks, maybe                                                                   // 77  // 130
      // https://jira.mongodb.org/browse/SERVER-3069 will get fixed one day                                // 78  // 131
      if (e.name !== 'MongoError') throw e                                                                 // 79  // 132
      match = e.err.match(/^E11000 duplicate key error index: ([^ ]+)/)                                    // 80  // 133
      if (!match) throw e                                                                                  // 81  // 134
      if (match[1].indexOf('$name') !== -1)                                                                // 82  // 135
        throw new Meteor.Error(403, "Role already exists.")                                                // 83  // 136
      throw e                                                                                              // 84  // 137
    }                                                                                                      // 85  // 138
  },                                                                                                       // 86  // 139
                                                                                                           // 87  // 140
  /**                                                                                                      // 88  // 141
   * Delete an existing role.  Will throw "Role in use" error if any users                                 // 89  // 142
   * are currently assigned to the target role.                                                            // 90  // 143
   *                                                                                                       // 91  // 144
   * @method deleteRole                                                                                    // 92  // 145
   * @param {String} role Name of role                                                                     // 93  // 146
   */                                                                                                      // 94  // 147
  deleteRole: function (role) {                                                                            // 95  // 148
    if (!role) return                                                                                      // 96  // 149
                                                                                                           // 97  // 150
    var foundExistingUser = Meteor.users.findOne(                                                          // 98  // 151
                              {roles: {$in: [role]}},                                                      // 99  // 152
                              {fields: {_id: 1}})                                                          // 100
                                                                                                           // 101
